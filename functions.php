...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        // wp_register_script('jquery-3.3.1', get_template_directory_uri() . '/js/lib/jquery-3.3.1.js', array('jquery'), '1.0.0'); // jQuery
        // wp_enqueue_script('jquery-3.3.1'); // Enqueue it!

        wp_register_script('html5blankscripts', get_template_directory_uri() . '/js/scripts.js', array('jquery'), '1.0.0'); // Custom scripts
        wp_enqueue_script('html5blankscripts'); // Enqueue it!

        // wp_register_script('jquery.stellar', get_template_directory_uri() . '/js/jquery.stellar.js', array('jquery'), '1.0.0'); // Stellar
        // wp_enqueue_script('jquery.stellar'); // Enqueue it!

        // wp_register_script('script', get_template_directory_uri() . '/js/script.js', array('jquery'), '1.0.0'); // Scripts
